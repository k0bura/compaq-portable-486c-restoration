# Keyboard Restoration — Compaq Portable 486c
...
- SalonCare 40 Volume Creme Developer (16 oz bottle)
- A pot large enough to submerge the keycaps
- A thermometer
- Kitchen gloves — the cream irritates skin
...
The retrobright technique was popularized by [The 8-Bit Guy](https://www.youtube.com/@The8BitGuy) (David Murray). His experiments showed that heat can replace UV light as the catalyst for the hydrogen peroxide reaction, making the process more consistent and accessible.

- [The 8-Bit Guy — Retrobright: How to turn yellow plastic white again](https://www.youtube.com/watch?v=VU7vXMezW_I)
- [The 8-Bit Guy — Adventures in Retrobrite: New techniques for restoring yellowed plastic!](https://www.youtube.com/watch?v=qZYbchvSUDY) (see [11:47](https://youtu.be/qZYbchvSUDY?t=707) for the heat method)
...
├── README.md       # This file
└── images/         # Restoration photos (TODO)
```
