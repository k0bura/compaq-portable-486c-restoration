# CPU Upgrade — Compaq Portable 486c
...
![Original IBM Blue Lightning DX2 on the Compaq motherboard](images/01-original-cpu.jpg)

## Upgrade — AMD Am5x86-P75 (AMD-X5-133ADZ)

The Am5x86 is a drop-in Socket 3 upgrade that delivers Pentium-75 equivalent performance (hence the "P75" marketing name) while remaining fully compatible with 486 motherboards. It runs at 133 MHz using a 4x internal clock multiplier on a 33 MHz bus, features a 16 KB write-back L1 cache, and draws only ~3W. See [`AM5x86_Datasheet.pdf`](AM5x86_Datasheet.pdf).

![AMD Am5x86-P75 ADZ variant](images/02-am5x86-adz.jpg)
...
![AMD Am5x86-P75 ADW variant — note "HEATSINK AND FAN REQD"](images/03-am5x86-adw.jpg)
...
![AMD Am5x86-P75 ADZ installed on the Compaq Portable 486c motherboard](images/04-am5x86-installed.jpg)
...
cpu-upgrade/
├── README.md                # This file
├── AM5x86_Datasheet.pdf     # AMD Am5x86 microprocessor family datasheet
└── images/
    ├── 01-original-cpu.jpg  # Original IBM Blue Lightning DX2 installed on motherboard
    ├── 02-am5x86-adz.jpg    # AMD Am5x86-P75 ADZ variant
    ├── 03-am5x86-adw.jpg    # AMD Am5x86-P75 ADW variant (note "HEATSINK AND FAN REQD")
    └── 04-am5x86-installed.jpg  # ADZ installed on the Compaq motherboard
```
