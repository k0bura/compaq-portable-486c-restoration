# Screen Replacement — Compaq Portable 486c
...
The full pin-by-pin mapping between the old 30-pin display connector and the new 31-pin connector is documented in [`datasheets/Compaq_Display_Pinout_Mapping.pdf`](datasheets/Compaq_Display_Pinout_Mapping.pdf).
...
The full 40-pin connector pinout is documented in [`40-pin-connector-pinout.md`](40-pin-connector-pinout.md).
...
![74AS02 wiring diagram — top/bottom pin views and logic diagram](images/09-74as02-wiring-diagram.png)
...
![VGA graphics mode test — 640×480, 16 colors](images/03-graphics-mode-test.jpg)
...
screen-replacement/
├── README.md                                    # This file
├── 40-pin-connector-pinout.md                   # 40-pin TTL LVDS adapter cable pinout
├── datasheets/
...
└── images/
    ...
    ├── 03-graphics-mode-test.jpg                # 640×480 16-color VGA test pattern
    ├── 04-delay-circuit-breadboard.jpg          # BLANK→DE delay circuit prototype
    ├── 05-doom-running.jpg                      # DOOM on the fully restored unit
    ├── 06-video-card-modifications.jpg          # Video card with 74AS02 and BLANK tap wires
